...
<head>
    ...
    <link
        href="<?php echo $this->customlib->getBaseUrl(); ?>uploads/school_content/admin_small_logo/<?php echo $this->setting_model->getAdminsmalllogo(); ?>"
    ...
    <div class="topaleart">
        <div class="slidealert">
            <div class="alert alert-dismissible topaleart-inside">
                <p class="palert"><strong>Alert!</strong> You are using unregistered version of Smart School. Please <a
                        href="#" class="purchasemodal">click here</a> to register your purchase code for Smart School.
                </p>
            </div>
        </div>
    </div>
                    ...
                    <div class="pull-right">
                        ...
                        <form id="header_search_form" class="navbar-form navbar-left search-form" role="search"
                            ...
                            <div class="input-group">
                                <input type="text" value="<?php echo set_value(
                                    "search_text1"
                                ); ?>" name="search_text1"
                                    id="search_text1" class="form-control search-form search-form3"
                        ...
                        <div class="navbar-custom-menu">
                            ...
                            <div class="langdiv" data-placement="bottom" data-toggle="tooltip"
                                title="<?php echo $this->lang->line(
                                    ...
                                    <?php $this->load->view(
                                        "admin/language/languageSwitcher"
                                    ); ?>
                            ...
                            <ul class="nav navbar-nav headertopmenu">
                                ...
                                if ($userdata["role_id"] == 7) {
                                    if (
                                        ($this->module_lib->hasModule(
                                            "multi_branch"
                                        ) &&
                                            $this->module_lib->hasActive(
                                                "multi_branch"
                                            )) ||
                                        $this->db->multi_branch
                                    ) { ?>

                                <li class="cal15" data-placement="bottom" data-toggle="tooltip"
                                    title="<?php echo $this->lang->line(
                                        "switch_branch"
                                    ); ?>"><a href="#"
                                        data-toggle="modal" data-target="#multiBranchSwitchModal"><i
                                ...
                                <li class="cal15 d-sm-none"><a data-placement="bottom" data-toggle="tooltip"
                                        title="<?php echo $this->lang->line(
                                            "calendar"
                                        ); ?>"
                                        href="<?php echo base_url(); ?>admin/calendar/events"><i
                                ...
                                <li class="dropdown" data-placement="bottom" data-toggle="tooltip"
                                    title="<?php echo $this->lang->line(
                                        "task"
                                    ); ?>">
                                    <a href="#" class="dropdown-toggle todoicon" data-toggle="dropdown">
                                        ...
                                        <?php
                                        $userdata = $this->customlib->getUserData();
                                        $count = $this->customlib->countincompleteTask(
                                            $userdata["id"],
                                            $userdata["role_id"]
                                        );
                                        if ($count > 0) { ?>
                                    ...
                                    <ul class="dropdown-menu menuboxshadow">
                                        ...
                                        <li class="todoview plr10 ssnoti">
                                            ...
                                            <?php echo $this->lang->line(
                                                ...
                                                class="pull-right pt0"><?php echo $this->lang->line(
                                                    "view_all"
                                                ); ?></a>
                                        </li>
                                        <li>
                                            <ul class="todolist">
                                                <?php
                                                $tasklist = $this->customlib->getincompleteTask(
                                                    $userdata["id"],
                                                    $userdata["role_id"]
                                                );
                                                foreach (
                                                ...
                                                <li>
                                                    <div class="checkbox">
                                                        <label><input type="checkbox"
                                                                id="newcheck<?php echo $value[
                                                                    "id"
                                                                ]; ?>"
                                                                onclick="markc('<?php echo $value[
                                                                    "id"
                                                                ]; ?>')"
                                                                name="eventcheck"
    ...
    "event_title"
                                ...
                                <li class="dropdown d-lg-none d-sm-block ellipsis-px-3">
                                    ...
                                    <ul class="dropdown-menu min-w-full sm-drop-down">
                                        <li><a href="<?php echo base_url(); ?>admin/calendar/events"><i
                                                    class="fa fa-calendar"></i></a></li>
                                        <li><a href="<?php echo base_url(); ?>admin/chat"><i
                                ...
                                <li class="cal15 d-sm-none"><a data-placement="bottom" data-toggle="tooltip" title=""
                                        href="<?php echo base_url(); ?>admin/chat"
                                ...
                                <li class="dropdown user-menu">
                                    <a class="dropdown-toggle" style="padding: 15px 12px;" data-toggle="dropdown"
                                                ...
                                                <div class="sspass">
                                                    <a href="<?php echo base_url() .
                                                        ...
                                                        data-original-title="<?php echo $this->lang->line(
                                                            ...
                                                            class="fa fa-user"></i><?php echo $this->lang->line(
                                                                "profile"
                                                            ); ?>
                                                    </a>
                                                    <a class="pl25"
                                                        ...
                                                        data-original-title="<?php echo $this->lang->line(
                                                            ...
                                                            class="fa fa-key"></i><?php echo $this->lang->line(
                                                                "password"
                                                            ); ?></a>
                                                    <a class="pull-right" href="<?php echo base_url(); ?>site/logout"><i
                                                            class="fa fa-sign-out fa-fw"></i><?php echo $this->lang->line(
                                                                "logout"
                                                            ); ?></a>
                                                </div>
                                            </div>
