<ul class="sessionul fixedmenu">
    ...
    <li class="removehover">
        <a data-toggle="modal"
            data-target="#sessionModal"><span><?php echo $this->lang->line('current_session') . ": " . $this->setting_model->getCurrentSessionName(); ?></span><i
            ...
            <div class="side-navbar-width scroll-area mCustomScrollbar">
                <div class="card-columns-sidebar" style="color: black;">
                    ...
                    <div class="card-sidebar">
                        <h4><i class="<?php echo $side_list_value->icon; ?>"></i>
                            <?php echo $this->lang->line($side_list_value->lang_key); ?></h4>
                        ...
                        <ul>
                            <?php
                                                ...
                                                ?>
                            <li>
                                <a href="<?php echo site_url($submenu_value->url); ?>"><i
                                        class="fa fa-angle-double-right"></i><?php echo $this->lang->line($submenu_value->lang_key); ?></a>
                            </li>
