         ...
         //   if ($this->rbac->hasPrivilege('class', 'can_add')) {
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <form id="form1" action="<?php echo site_url('lession'); ?>" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                <?php 
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('sonu'); ?></label><small class="req"> *</small>
