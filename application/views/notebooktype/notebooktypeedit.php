                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input autofocus="" id="note_book_title" name="note_book_title" placeholder="" type="text" class="form-control" value="<?php echo $editnotbooktype[0]->note_book_title; ?>" />
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input autofocus="" id="remarks" name="remarks" placeholder="" type="text" class="form-control" value="<?php echo $editnotbooktype[0]->remark; ?>" />
